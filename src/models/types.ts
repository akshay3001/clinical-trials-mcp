...
export const StatusModuleSchema = z
  .object({
...
export const ArmsInterventionsModuleSchema = z
  .object({
    armGroups: z
      .array(
        z
...
export const EligibilityModuleSchema = z
  .object({
...
export const ContactsLocationsModuleSchema = z
  .object({
    centralContacts: z
      .array(
        z
...
export const SponsorCollaboratorsModuleSchema = z
  .object({
    leadSponsor: z
      .object({
        name: z.string().optional(),
...
export const OutcomesModuleSchema = z
  .object({
    primaryOutcomes: z
      .array(
        z
...
export const OversightModuleSchema = z
  .object({
...
export const ReferencesModuleSchema = z
  .object({
    references: z
      .array(
        z
...
export const IpdSharingStatementModuleSchema = z
  .object({
...
export const ProtocolSectionSchema = z
  .object({
